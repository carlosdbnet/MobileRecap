...
cls
echo ========================================
echo     MobRecap - Sistema de Coleta
echo ========================================
echo.
...
echo ========================================
cd /d C:\Sistema\MobRecap\backend
echo P1call venv\Scripts\activate.bat
if errorlevel 1 (
...
start "MobRecap Backend" cmd /k "cd /d %BASE_DIR%backend && venv\Scripts\python -m uvicorn main:app --host 0.0.0.0 --port 8082"
goto menu
...
start "MobRecap Frontend" cmd /k "cd /d %BASE_DIR%frontend && npx expo start"
goto menu
