    ...
    <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
      ...
      <View style={styles.grid}>
        <View style={styles.gridItem}>
          <Text style={[styles.label, { color: colors.textSecondary }]}>Medida</Text>
          <Text style={[styles.value, { color: colors.text }]}>{item.MEDIDA || '-'}</Text>
        </View>
        <View style={styles.gridItem}>
          <Text style={[styles.label, { color: colors.textSecondary }]}>Desenho</Text>
          <Text style={[styles.value, { color: colors.text }]}>{item.DESENHO || '-'}</Text>
        </View>
        <View style={styles.gridItem}>
          <Text style={[styles.label, { color: colors.textSecondary }]}>OS</Text>
          <Text style={[styles.value, { color: colors.text }]}>{item.NUMOS || '-'}</Text>
        </View>
      </View>
      ...
      <View style={styles.footer}>
        ...
        <Text style={[styles.footerText, { color: colors.textSecondary }]}>
          {item.MARCA || 'Marca N/A'} | Placa: {item.PLACA || '-'}
        </Text>
      </View>
    </View>
  );
