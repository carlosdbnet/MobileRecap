...
export default function DrawerNavigator() {
  ...
  return (
    ...
    >
      ...
      <Drawer.Screen name="Pneus" component={PneusScreen} options={{ 
        drawerIcon: ({ color, size }) => <MaterialCommunityIcons name="tire" color={color} size={size} />
      }} />
...
const styles = StyleSheet.create({
  drawerHeader: { padding: 20, borderBottomWidth: 1 },
