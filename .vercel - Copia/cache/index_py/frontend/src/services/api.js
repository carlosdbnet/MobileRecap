...
api.interceptors.request.use(
  async (config) => {
    try {
      ...
      const ip = savedIp || 'mobile-recap.vercel.app'; 
      const port = savedPort || '';

      // Lógica para detectar se é uma URL completa do Vercel ou um IP local
      ...
      config.baseURL = 'http://192.168.18.99:8082'; // fallback local
      return config;
    }
  },
